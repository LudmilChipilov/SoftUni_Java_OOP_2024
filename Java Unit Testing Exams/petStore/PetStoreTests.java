...
public class PetStoreTests
{
    private final double DELTA = 0.0000;
     ...
     public void test_Animal_Constructor_Should_Initialize_Correctly()
     {
         ...
         Assert.assertEquals("Ludmil", animal.getSpecie());
         Assert.assertEquals(100, animal.getMaxKilograms());
         Assert.assertEquals(50.50, animal.getPrice(), DELTA);
         animal.setAge(10);
    ...
    public void test_PetStore_findAllAnimalsWithMaxKilograms_Should_Return_All_Animals_With_MaxKg_Bigger_Than_Given()
    {
        ...
        Assert.assertEquals(expected, petStore.findAllAnimalsWithMaxKilograms(20));
    }
    ...
    public void test_PetStore_findAllAnimalBySpecie_Should_Return_All_Animals_By_Given_Species()
    {
        ...
        expected.add(animal3);
        expected.add(animal4);
        Assert.assertEquals(expected, petStore.findAllAnimalBySpecie("SS"));
    }
}
